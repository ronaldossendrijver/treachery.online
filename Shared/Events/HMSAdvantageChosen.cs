...
namespace Treachery.Shared
{
    public class HMSAdvantageChosen : GameEvent
    {
        ...
        {
            return g.ChosenHMSAdvantage == StrongholdAdvantage.None && g.CurrentBattle?.Territory == g.Map.HiddenMobileStronghold.Territory && g.HasStronghold(p.Faction, g.Map.HiddenMobileStronghold) && ValidAdvantages(g, p).Any();
        }
