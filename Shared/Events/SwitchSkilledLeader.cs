...
namespace Treachery.Shared
{
    public class SwitchedSkilledLeader : GameEvent
    {
        ...
        public static Leader SwitchableLeader(Game game, Player player) => player.Leaders.FirstOrDefault(l => game.IsSkilled(l) && !game.CapturedLeaders.ContainsKey(l) && l.HeroType != HeroType.PinkAndCyan );
