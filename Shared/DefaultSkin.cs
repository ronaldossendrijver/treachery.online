...
public static class DefaultSkin
{
    ...
    public static Skin Default { get; } = new()
    {
        ...
        TreacheryCardDescription_STR = new Dictionary<int, string>
            ...
            .Concat(Game.ExpansionLevel < 1 ? Array.Empty<KeyValuePair<int, string>>() : new Dictionary<int, string>
            ...
            ).Concat(Game.ExpansionLevel < 2 ? Array.Empty<KeyValuePair<int, string>>() : new Dictionary<int, string>
                {
                    ...
                    [53] = "Weapon - Special - Play as part of your Battle Plan. You choose after plans are revealed to either kill both leaders or reduce the strength of both leaders to 0. The player with the highest number of undialed forces wins the battle. Dialed forces are lost normally. Discard after use.",
        ...
        LocationCenter_Point = new Dictionary<int, PointD>
        {
            ...
            [5] = new (348, 146), //Arrakeen
            [6] = new (451, 407), //Tuek's Sietch
            [7] = new (110, 201), //Sietch Tabr
            [8] = new (109, 408), //Habbanya Sietch
            [9] = new (241, 417), //Cielago North (West Sector)
            [10] = new (279, 421), //Cielago North (Center Sector)
            [11] = new (316, 416), //Cielago North (East Sector)
            [12] = new (236, 457), //Cielago Depression (West Sector)
            [13] = new (277, 454), //Cielago Depression (Center Sector)
            [14] = new (324, 461), //Cielago Depression (East Sector)
            [15] = new (217, 511), //Meridian (West Sector)
            [16] = new (253, 523), //Meridian (East Sector)
            [17] = new (296, 498), //Cielago South (West Sector)
            [18] = new (326, 497), //Cielago South (East Sector)
            [19] = new (358, 462), //Cielago East (West Sector)
            [20] = new (380, 468), //Cielago East (East Sector)
            [21] = new (312, 355), //Harg Pass (West Sector)
            [22] = new (333, 346), //Harg Pass (East Sector)
            [23] = new (388, 434), //False Wall South (West Sector)
            [24] = new (394, 393), //False Wall South (East Sector)
            [25] = new (319, 333), //False Wall East (Far South Sector)
            [26] = new (326, 320), //False Wall East (South Sector)
            [27] = new (332, 303), //False Wall East (Middle Sector)
            [28] = new (325, 284), //False Wall East (North Sector)
            [29] = new (316, 276), //False Wall East (Far North Sector)
            [30] = new (367, 355), //The Minor Erg (Far South Sector)
            [31] = new (361, 326), //The Minor Erg (South Sector)
            [32] = new (379, 295), //The Minor Erg (North Sector)
            [33] = new (371, 268), //The Minor Erg (Far North Sector)
            [34] = new (408, 365), //Pasty Mesa (Far South Sector)
            [35] = new (433, 336), //Pasty Mesa (South Sector)
            [36] = new (439, 288), //Pasty Mesa (North Sector)
            [37] = new (431, 234), //Pasty Mesa (Far North Sector)
            [38] = new (489, 279), //Red Chasm
            [39] = new (446, 473), //South Mesa (South Sector)
            [40] = new (460, 449), //South Mesa (Middle Sector)
            [41] = new (507, 346), //South Mesa (North Sector)
            [42] = new (428, 129), //Basin
            [43] = new (367, 179), //Rim Wall West
            [44] = new (393, 187), //Hole In The Rock
            [45] = new (428, 159), //Sihaya Ridge
            [46] = new (383, 235), //Shield Wall (South Sector)
            [47] = new (355, 235), //Shield Wall (North Sector)
            [48] = new (477, 190), //Gara Kulon
            [49] = new (400, 118), //OH Gap (East Sector)
            [50] = new (357, 93), //OH Gap (Middle Sector)
            [51] = new (312, 80), //OH Gap (West Sector)
            [52] = new (278, 82), //Broken Land (East Sector)
            [53] = new (219, 97), //Broken Land (West Sector)
            [54] = new (272, 114), //Tsimpo (East Sector)
            [55] = new (230, 137), //Tsimpo (Middle Sector)
            [56] = new (192, 178), //Tsimpo (West Sector)
            [57] = new (275, 223), //Arsunt (East Sector)
            [58] = new (266, 268), //Arsunt (West Sector)
            [59] = new (124, 156), //Rock Outcroppings (North Sector)
            [60] = new (81, 180), //Rock Outcroppings (South Sector)
            [61] = new (198, 132), //Plastic Basin (North Sector)
            [62] = new (165, 165), //Plastic Basin (Middle Sector)
            [63] = new (172, 254), //Plastic Basin (South Sector)
            [64] = new (235, 188), //Hagga Basin (East Sector)
            [65] = new (199, 203), //Hagga Basin (West Sector)
            [66] = new (71, 214), //Bight Of The Cliff (North Sector)
            [67] = new (67, 244), //Bight Of The Cliff (South Sector)
            [68] = new (85, 261), //Funeral Plain
            [69] = new (143, 295), //The Great Flat
            [70] = new (236, 287), //Wind Pass (Far North Sector)
            [71] = new (227, 303), //Wind Pass (North Sector)
            [72] = new (213, 327), //Wind Pass (South Sector)
            [73] = new (207, 357), //Wind Pass (Far South Sector)
            [74] = new (155, 327), //The Greater Flat
            [75] = new (84, 371), //Habbanya Erg (West Sector)
            [76] = new (145, 375), //Habbanya Erg (East Sector)
            [77] = new (190, 334), //False Wall West (North Sector)
            [78] = new (176, 374), //False Wall West (Middle Sector)
            [79] = new (163, 449), //False Wall West (South Sector)
            [80] = new (241, 336), //Wind Pass North (North Sector)
            [81] = new (247, 355), //Wind Pass North (South Sector)
            [82] = new (79, 408), //Habbanya Ridge Flat (West Sector)
            [83] = new (152, 485), //Habbanya Ridge Flat (East Sector)
            [84] = new (205, 402), //Cielago West (North Sector)
            [85] = new (201, 463) //Cielago West (South Sector)
        },

        LocationSpice_Point = new Dictionary<int, PointD>
        {
            [11] = new (309, 393), //Cielago North (East Sector)
            [17] = new (290, 539), //Cielago South (West Sector)
            [33] = new (362, 272), //The Minor Erg (Far North Sector)
            [38] = new (509, 292), //Red Chasm
            [40] = new (491, 401), //South Mesa (Middle Sector)
            [45] = new (442, 144), //Sihaya Ridge
            [50] = new (335, 86), //OH Gap (Middle Sector)
            [53] = new (196, 99), //Broken Land (West Sector)
            [60] = new (94, 176), //Rock Outcroppings (South Sector)
            [65] = new (216, 233), //Hagga Basin (West Sector)
            [68] = new (59, 266), //Funeral Plain
            [69] = new (55, 293), //The Great Flat
            [75] = new (60, 367), //Habbanya Erg (West Sector)
            [80] = new (233, 340), //Wind Pass North (North Sector)
            [83] = new (133, 483) //Habbanya Ridge Flat (East Sector)
        },
