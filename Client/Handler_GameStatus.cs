        ...
        public GameStatus DetermineStatus()
        {
            switch (Game.CurrentPhase)
            {
                ...
                case Phase.TurnConcluded:
                    return new GameStatus(Skin.Current.Format("Factions may now review the {0} report...", Game.CurrentReport.About));
                ...
                case Phase.SelectingFactions: return new GameStatus(Skin.Current.Format("Players may now choose a faction..."));

                case Phase.TradingFactions: return new GameStatus(Skin.Current.Format("Players may now offer to trade factions with other players..."));
                ...
                case Phase.Thumper:
                    ...
                    {
                        return new GameStatus(Skin.Current.Format("You may now proceed to the first Spice Blow"), Skin.Current.Format("Waiting for the host to proceed to the first Spice Blow"));
                    }
                ...
                case Phase.WaitingForNextBiddingRound: return new GameStatus(Skin.Current.Format("Factions are waiting for the next card to be put on auction..."));
                ...
                case Phase.ShipmentAndMoveConcluded: return new GameStatus(Skin.Current.Format("Waiting for factions to be ready to enter the Battle phase..."));

                case Phase.BeginningOfBattle: return new GameStatus(Skin.Current.Format("You may proceed to the first battle when ready."), Skin.Current.Format("Waiting for the host to proceed to the first battle..."));
                ...
                case Phase.GameEnded:
                    return new GameStatus(Skin.Current.Format("The game has ended."));
            }

            return new GameStatus(Skin.Current.Format("Unknown phase."));
        }
