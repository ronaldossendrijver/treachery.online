...
namespace Treachery.Test
{
    public class Statistics
    {
        ...
        public void Output(IDescriber describer)
        {
            ...
            Console.WriteLine("Total Game Time (minutes):" + GameTimes.Sum(t => t.TotalMinutes));
        ...
        private void OutputCounter<T>(string title, ObjectCounter<T> c, IDescriber describer)
        {
            Console.WriteLine(title);
            foreach (var i in c.Counted)
            {
